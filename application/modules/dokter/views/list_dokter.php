...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">List Dokter</h5>
					...
					<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="<?php echo base_url() ?>dokter/detail/<?php echo $u->id_petugas ?>">Edit</a>
								</li>
								<li><a href="<?php echo base_url();?>dokter/delete/<?php echo $u->id_petugas;?>" onClick="return confirm('Apakah Anda yakin ingin Menghapus Data Dokter Ini ?')">Delete</a>
								</li>
							</ul>
						</li>
					</ul>
...
<div id="modal_form_dokter" class="modal fade" style="display: none;">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form role="form" action="#" id="form-dokter" method="post" class="form-horizontal">
	...
	$(document).ready(function(){
		...
		$('.datatables-lists').DataTable({
			buttons: {
				...
				buttons: [
					{
					text: '<data-toggle="modal" data-target="#modal_form_dokter"> <i class="icon-plus-circle2"></i> Tambah Dokter ',
					className: 'btn bg-primary-400',
						action: function(e, dt, node, config) {
						$('#modal_form_dokter').modal('show');
					}
				}
				]
			}
		...
		$("#submit-form").click(function(e){
			...
			cancelButtonText: "No, cancel plx!",
			  ...
			  if (result.value) {
				$.ajax({
					type: 'post',
					url: '<?php echo base_url();?>dokter/save',
					data: form.serialize(),
					error: function () {
