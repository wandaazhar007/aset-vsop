...
class Fisioterapis extends MX_Controller 
{
	public function __construct() {
		parent::__construct();
		$this->auth->adminRestrict();
		$this->load->helper('text');
		$this->load->model('m_fisioterapis');
		
	}
	
	public function index() {
		$data['title'] = 'Data Fisioterapis';
		$data['view'] = 'list_fisioterapis';
		$data['fisioterapis'] = $this->m_fisioterapis->get_fisioterapis();
		$this->load->view('templates_backend',$data);
	}
	
	public function detail($id_petugas) {
		$data['title']	= 'Detail Data Fisioterapis';
		$data['view']	= 'detail_fisioterapis';
		$data['detail_fisioterapis']	= $this->m_fisioterapis->getById($id_petugas);
		$this->load->view('templates_backend',$data);
	}
	...
	function save()
	{
		...
		$this->m_fisioterapis->input($data, 'tb_petugas');
	...
	function update()
	{
		...
		$this->m_fisioterapis->update('tb_petugas','id_petugas', $id_petugas, $data);
