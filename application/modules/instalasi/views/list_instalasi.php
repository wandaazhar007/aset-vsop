...
<div class="panel panel-flat">
	...
	<table class="table datatables-lists">
		...
		<tbody>
			<?php
				$no = 1;
				if(!empty($f_instalasi)){
					foreach($f_instalasi as $u){
					
			?>
			<tr>
				<td><?php echo $no++ ?></td>
				<td><?php echo $u->nama_instalasi ?></td>
					...
					<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="<?php echo base_url() ?>instalasi/detail/<?php echo $u->id_instalasi ?>">Edit</a>
								</li>
								<li><a href="<?php echo base_url();?>instalasi/delete/<?php echo $u->id_instalasi;?>" onClick="return confirm('Apakah Anda yakin ingin Menghapus Data Instalasi Ini ?')">Delete</a>
								</li>
							</ul>
						</li>
					</ul>
...
<div id="modal-form-instalasi" class="modal fade" style="display: none;">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			<div class="modal-header bg-teal">
				<button type="button" class="close" data-dismiss="modal">×</button>
				<h5 class="modal-title" align="center">Tambah Data Instalasi</h5>
			</div>

			<form role="form" action="#" id="form-instalasi" method="post" class="form-horizontal">
				<div class="modal-body">
					<div class="form-group">
						<label class="control-label col-sm-3">Nama Instalasi</label>
						<div class="col-sm-9">
							<input type="text" name="nama_instalasi" id="nama_instalasi" class="form-control" placeholder="Nama Instalasi">
						</div>
					</div>
				</div>
			...
			buttons: {
				...
				buttons: [
					...
					className: 'btn bg-teal-400',
						...
						$('#modal-form-instalasi').modal('show');
					}
				}
				]
			}
		...
		$("#submit-form").click(function(e){
			...
			cancelButtonText: "No, cancel plx!",
			  ...
			  if (result.value) {
				$.ajax({
					type: 'post',
					url: '<?php echo base_url();?>instalasi/save',
					data: form.serialize(),
					error: function () {
