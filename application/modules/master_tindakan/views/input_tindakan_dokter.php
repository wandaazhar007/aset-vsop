        ...
        <div class="panel panel-default">
            <div class="panel-head">
                <div class="panel-title">
                    <span class="panel-title-text">Input Data Tindakan</span>
                </div>
            </div>
            <div class="panel-body">
                <form role="form" action="<?php echo base_url(); ?>master_tindakan/tindakan_dokter/save" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="harga_tindakan" id="harga_tindakan" placeholder="Rp.">
