	...
	<div class="col-12">
    	<div class="panel panel-default">
        	<div class="panel-head">
            	<a href="<?php echo base_url('master_tindakan/tindakan_fisio/input');?>" class="btn btn-outline btn-secondary btn-pill btn-outline-2x m-1">
                    ...
                    <tbody>
						...
						?>
                       	<tr>
                            ...
                            <td><?php //echo $this->partolibs->cekPos($p->posisi, 'label'); ?></td>
                            <td class="text-center">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdown-button-3">
                                    <li><a onClick="return confirm('Apakah Anda yakin ingin Membatalkan Registrasi Pasien Tersebut ?')" href="#<?php //echo base_url();?>pendaftaran/batal/<?php //echo $p->no_registrasi;?>">Batalka Registrasi</a></li>
                                </ul>
                        	</td>
                        </tr>
                		<?php }}?>                
