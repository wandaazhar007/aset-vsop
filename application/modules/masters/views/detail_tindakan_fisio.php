		...
		<form role="form" action="#" id="form-update" method="post" class="form-horizontal">
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">Detail Tindakan Fisioterapis<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="control-label col-sm-3">Nama Tindakan Fisioterapis</label>
						<div class="col-sm-9">
		...
		$("#submit-form").click(function(e){
			...
			cancelButtonText: "No, cancel plx!",
			  ...
			  if (result.value) {
				$.ajax({
					type: 'post',
					url: '<?php echo base_url();?>masters/tindakan_fisio/update',
					data: form.serialize(),
					error: function () {
