...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">List Master Tindakan Fisio</h5>
					...
					<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="<?php echo base_url();?>masters/tindakan_fisio/detail/<?php echo $t->id_tindakan_master;?>">Edit</a>
								</li>
								<li><a onClick="return confirm('Apakah Anda yakin ingin Menghapus Data Tindakan Ini ?')" href="<?php echo base_url();?>masters/tindakan_fisio/delete/<?php echo $t->id_tindakan_master;?>">Delete</a>
								</li>
							</ul>
						</li>
					</ul>
...
<!--Modal-->
<div id="modal_tindakan_fisio" class="modal fade" style="display: none;">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header bg-primary">
				<button type="button" class="close" data-dismiss="modal">×</button>
				<h5 class="modal-title">Tambah Tindakan Fisio</h5>
			</div>

			<form action="#" id="tindakan-fisio" class="form-horizontal">
			...
			buttons: [
				{
					...
					action: function(e, dt, node, config) {
						$('#modal_tindakan_fisio').modal('show');
					}
				}
			]
		});
...
<script type="text/javascript">
	$(document).ready(function(){
		var form = $('#tindakan-fisio');
		$("#submit-form").click(function(e){
			e.preventDefault();
			Swal.fire({   
			title: "Apakah Data Tindakan Fisio Sudah Benar ?",   
			...
			cancelButtonText: "No, cancel plx!",
			  ...
			  if (result.value) {
				$.ajax({
					type: 'post',
					url: '<?php echo base_url();?>masters/tindakan_fisio/save',
					data: form.serialize(),
					error: function () {
