                        ...
                        <div class="row">
							<div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <span class="help-block"><i>Silahkan Isi Nama Lengkap Pasien</i></span> 
                                </div>
                            </div>
							<div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <span class="help-block"><i>*Nomor Induk KTP Pasien</i></span> 
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        	<div class="col-md-6">
								<div class="form-group">
									...
									<span class="help-block"><i>*contoh : saputra@gmail.com</i></span>
								</div>
							</div>
							<div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
									...
									<span class="help-block"><i>Isi Nama Kota/Kabupaten</i></span>
                                </div>
                            </div>
							<div class="col-md-6">
                                <div class="form-group">
