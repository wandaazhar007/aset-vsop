	...
	<div class="col-md-12">
		...
		<?php 
				if(!empty($detail_ruangan))
				{
					...
					foreach($detail_ruangan as $u)
					{ 
			?>
		<form role="form" action="#" id="form-update" method="post" class="form-horizontal">
			<div class="panel panel-flat">
				<div class="panel-heading">
					<a href="<?php echo base_url('ruangan'); ?>"><i class="glyphicon glyphicon-arrow-left"></i> &nbsp; Kembali</a>
					<h5 class="panel-title" align="center">Edit Data Ruangan<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
				...
				<div class="panel-body">
					<div class="form-group hide">
						<div class="col-sm-9">
							<input type="text" name="id_ruangan" id="id_ruangan" value="<?php echo $u->id_ruangan;?>" class="form-control">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="nama_ruangan" id="nama_ruangan" value="<?php echo $u->nama_ruangan;?>" class="form-control">
						</div>
					</div>
